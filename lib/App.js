...
import styled, { ThemeProvider, theme as myDataTheme } from './theme'
...
const getTabBarItem = (route, routeIndex, currentNavIndex, onTabPress) => {
  ...
  return route.key === 'QR-kod' ? (
    <NavItemQRBackground key={route.key} style={{ ...iphoneXQRIconStyles }}>
...
const TabBar = ({ navigation, onTabPress }) => (
  <TabBarContainer>
    <TabBarInnerBlock style={{ ...iphoneXTabBarStyles }} />
