...
import { Path, G, Circle, Defs } from 'react-native-svg'
// stroke={theme.colors.quiet}
export default {
  qr: {
    svg: (
      <G>
        <Circle strokeWidth={8} cx={61.5} cy={59.5} r={49.5} fill="#04ABFF" />
        <Path
          strokeWidth={0}
          stroke="none"
          d="M65.04 54.333h4.43v4.445h-4.43v-4.445zM69.484 49.889h4.43v4.444h-4.43V49.89z"
          fill="#fff"
        />
        <Path
          strokeWidth={0}
          ...
          fillRule="evenodd"
          clipRule="evenodd"
          d="M73.93 54.334h4.444v13.333h4.444v4.444h-8.889v-4.444h-4.445v-4.445h4.445v-8.889z"
          fill="#fff"
        />
        <Path
          strokeWidth={0}
          stroke="none"
          d="M82.818 58.778h4.445v8.889h-4.445v-8.89z"
          fill="#fff"
        />
        <Path
          strokeWidth={0}
          ...
          fillRule="evenodd"
          clipRule="evenodd"
          d="M51.706 41H42.89v4.444h-4.444v4.445H34v4.444H42.889V49.89h4.373v-4.445h4.444v8.889h-4.444v4.445H42.89v4.444h4.372v4.444H42.89v4.445h-4.445v4.444H42.89V81h4.373v-4.444H51.707V72.11h4.444v-4.444h4.444v-4.445.014h4.445v-4.458H56.15v-4.445h4.444v-8.889H56.151V41h-4.445zm4.444 22.222h-4.443v-4.444h4.443v4.444z"
          fill="#fff"
        />
        <Defs />
      </G>
