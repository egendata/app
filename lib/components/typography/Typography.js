...
export const ScreenHeaderH3 = styled(Text)`
  color: ${({ theme }) => theme.colors.primary};
  font-family: ${({ theme }) => theme.typography.contrast};
  font-size: ${({ theme }) => theme.fontSize.regularMedium};
`
...
export const StyledPre = styled(Text)`
  color: ${({ theme }) => theme.colors.text.pre};
  font-size: ${({ theme }) => theme.fontSize.small};
`
