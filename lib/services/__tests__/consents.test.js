...
<<<<<<< HEAD:app/__tests__/services/consents.test.js
...
import { rsaPublicKeyToPEM } from '../rsaUtils'
import { Base64 } from 'js-base64'
// import * as jwksService from '../jwks'

jest.mock('../storage')
// jest.mock('../jwks')
>>>>>>> master:app/lib/services/__tests__/consents.test.js
...
=======
    consentRequest = {
      ...
      signature: {
        ...
        alg: 'RSA-SHA512',
        data:
          'rgch6Go3B56tB4UGLJiQAMKofRRmQdoSMp1teXp3Zj8V/ueyxmxbLywbjxuMTT63hfR/0Ueb+YUo60ygeQtL9l1SaT7gZjY56Ft3WASVD5pEVFw863oCr9DqIpm2jMdlUeIT1lZLJ7R1tfETLvy+vk1blaDDswfq46lFYC6OqRA=',
        key:
      ...
      keys: [
        {
          ...
          kty: 'RSA',
          n:
            'AMcq3gQT5ZpoDr73G5HrQpsvuB+fsgQqdKtfIM5kJLB7mmoOUwxoD+bGIrvC+bIHBmtQE+SudYjLtYOjEX3HnoPw2oE7+zNhIlRFOBB2aGlMozWzssJqqfhAvDdkZGeS8SfJjo1VjozxA+iQVjjMmU2+Wnw1Z0cY1p3+OZchkqOn',
          e: 'AQAB',
        },
        {
          kid: 'enc_20190114122318',
  ...
  describe('#get', () => {
    it('calls axios.get with correct url', async () => {
      ...
      expect(axios.get).toBeCalledWith(
        'aTotallyLegitOperatorUrl/consents/requests/abcd?accountId=c1949de3-6662-43c9-8cc1-578169ea817b'
      )
    })
    it('throws if signature does not verify', () => {
      consentRequest.signature.data = 'b0rk'

      return expect(consentService.get('abcd')).rejects.toThrowError(
        'Invalid signature'
      )
    })
  ...
  describe('#approve', () => {
    ...
    it('calls axios.post with correct url', async () => {
      ...
      expect(axios.post).toHaveBeenCalledWith(
        'aTotallyLegitOperatorUrl/consents',
        expect.any(Object)
      )
    })
